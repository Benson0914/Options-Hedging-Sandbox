...
if __name__ == '__main__':
    ...
    price_changes = np.random.normal(0, 0.002, total_steps) 
    ...
    plt.title('The Ultimate Sandbox Arena: Short MM vs Long Scalper (Full Multi-Threshold Matrix)', fontsize=14)
